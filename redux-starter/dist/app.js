...
eval("const {BUG_ADDED, BUG_REMOVED, BUG_RESOLVED} = __webpack_require__(/*! ./actionTypes */ \"./src/actionTypes.js\")\n\nmodule.exports = {\n\n    bugAdded : description=> ({\n            type: BUG_ADDED,\n            payload: {\n                description\n            }\n    }),\n    \n    bugResolved : id => ({\n        type: BUG_RESOLVED,\n        payload: {\n            id\n        }\n    })\n}\n\n\n//# sourceURL=webpack:///./src/actions.js?");
